      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="orderDetails.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Opinion</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="tickets.php">All Opinion</a>
                                </li>
								<?php
                      ...
                      <div class="row">
                        <div class="input-field col s12">
							...
							<select id="payment_type" name="payment_type">
									<option value="Wallet" selected>Card Payment</option>
									<option value="Cash On Delivery" <?php if(!$verified) echo 'enable';?>>Cash on Delivery</option>							
							</select>
                        </div>
                      </div>					
                      <div class="row">
