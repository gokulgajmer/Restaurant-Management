        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                    <li><h1 class="logo-wrapper"><p style="text-align:center;margin-bottom:30px; ">Everest Cuisine</p></h1></li>
                    </ul>
    ...
    <div class="wrapper">
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="orderDetails.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
            </li>
                <li class="no-padding">
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Opinion</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
								if(!isset($_GET['status'])){
									...
									"><a href="tickets.php">All Opinion</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Opinion</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <p class="caption">If you're experiencing any issues, contact us by leaving an opinion.</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Create an opinion</h4>
              </div>
<div>
        ...
        <div class="container">
          <p class="caption">List of your opinion</p>
          <div class="divider"></div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        ...
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Govinda BHandari</a></span>
        </div>
    </div>
  </footer>
